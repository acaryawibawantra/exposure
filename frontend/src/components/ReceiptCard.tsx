          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="relative">
              <select
                ...
                className="w-full bg-white border border-neutral-200 text-neutral-800 rounded-full px-5 py-2.5 text-sm appearance-none outline-none focus:ring-2 focus:ring-[#f48fb1]/50 focus:border-[#f48fb1] shadow-sm transition-all cursor-pointer font-jakarta"
              >
                <option value=""></option>
                {tenants.map((t) => (
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <div className="relative">
              <input
                ...
                className="w-full bg-white border border-neutral-200 text-neutral-800 rounded-full px-5 py-2.5 pr-10 text-sm outline-none focus:ring-2 focus:ring-[#f48fb1]/50 focus:border-[#f48fb1] shadow-sm transition-all cursor-pointer font-jakarta"
              />
